...
public class MuleConfigGeneratorTest {
    ...
    public void testGenerate() throws Exception {
        ...
        HttpListener4xConfig listenerConfig = new HttpListener4xConfig(HttpListener4xConfig.DEFAULT_CONFIG_NAME, "localhost", "8080","HTTP", API.DEFAULT_BASE_PATH);
        ...
        MuleConfigGenerator muleConfigGenerator = new MuleConfigGenerator(mock, new File(""), entries, new HashMap<String, HttpListener4xConfig>(), null, DEFAULT_MULE_VERSION, DEFAULT_RUNTIME_EDITION);
    ...
    public void testGenerateFlowWithXmlExample() throws Exception {
        ...
        Diff diff = XMLUnit.compareXML("<flow xmlns=\"http://www.mulesoft.org/schema/mule/core\" name=\"get:/pet\"><ee:transform xmlns:ee=\"http://www.mulesoft.org/schema/mule/ee/core\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.mulesoft.org/schema/mule/ee/core http://www.mulesoft.org/schema/mule/ee/core/current/mule-ee.xsd\"><ee:message><ee:set-payload><![CDATA[%dw 2.0 output application/xml --- { Pet: { name: \"John\", lastname: \"Doe\" } }]]></ee:set-payload></ee:message></ee:transform></flow>", s);
    ...
    public void blankDocumentWithoutLCInDomain() throws Exception {
        ...
        HttpListener4xConfig listenerConfig = new HttpListener4xConfig(HttpListener4xConfig.DEFAULT_CONFIG_NAME, "localhost", "8080","HTTP", "");
        API api = mock(API.class);
        when(api.getPath()).thenReturn("/api/*");
        when(api.getHttpListenerConfig()).thenReturn(listenerConfig);
        File raml = mock(File.class);
        ...
        MuleConfigGenerator muleConfigGenerator =
                new MuleConfigGenerator(mock(Log.class), new File(""), new ArrayList<GenerationModel>(), new HashMap<String, HttpListener4xConfig>(), null, DEFAULT_MULE_VERSION, DEFAULT_RUNTIME_EDITION);
