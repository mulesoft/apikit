...
public class APIKitConfigParser implements MuleConfigFileParser {
  ...
  public Map<String, APIKitConfig> parse(Document document) {
    ...
    for (Element element : elements) {
      ...
      Attribute outboundHeadersMapName =
          element.getAttribute(APIKitConfig.OUTBOUND_HEADERS_MAP_ATTRIBUTE);
      ...
      String configId =
          apiKitConfig.getName() != null ? apiKitConfig.getName() : APIKitFlow.UNNAMED_CONFIG_NAME;
