 ...
 * </code>
 */
public class JacksonData implements Serializable
{

    private JsonNode node;

    public JacksonData(JsonNode node)
    {
        this.node = node;
    }

    public JacksonData(URL node) throws IOException
    {
        this(node.openStream());
    }

    public JacksonData(InputStream node) throws IOException
    {
        this.node = new ObjectMapper().readTree(node);
    }

    public JacksonData(Reader node) throws IOException
    {
        this.node = new ObjectMapper().readTree(node);
    }

    public JacksonData(String node) throws IOException
    {
