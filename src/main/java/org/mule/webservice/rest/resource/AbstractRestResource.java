...
import org.mule.webservice.rest.action.RestAction;
...
public abstract class AbstractRestResource implements RestResource
{
    ...
    private RestAction getAction(ResourceOperationType actionType)
    {
    ...
    @Override
    public MessageProcessor getAction(ResourceOperationType actionType, MuleEvent muleEvent) throws RestActionNotAllowedException
    {
    ...
    @Override
    public boolean isActionSupported(ResourceOperationType actionType)
    {
