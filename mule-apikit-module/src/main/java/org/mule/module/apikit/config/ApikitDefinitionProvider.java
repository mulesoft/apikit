  ...
  public List<ComponentBuildingDefinition> getComponentBuildingDefinitions() {
    ComponentBuildingDefinition.Builder baseDefinition =
        new ComponentBuildingDefinition.Builder()
            .withNamespace(ApikitXmlNamespaceInfoProvider.APIKIT_NAMESPACE);
    ...
    definitions.add(
                    baseDefinition
                        ...
                        .withSetterParameterDefinition(
                                                       ...
                                                       fromSimpleParameter("outboundHeadersMapName").build())
                        .withSetterParameterDefinition(
                                                       "httpStatusVarName", fromSimpleParameter("httpStatusVarName").build())
                        .withSetterParameterDefinition(
                                                       "keepApiBaseUri", fromSimpleParameter("keepApiBaseUri").build())
                        .withSetterParameterDefinition(
                                                       "keepRamlBaseUri", fromSimpleParameter("keepRamlBaseUri").build())
                        .withSetterParameterDefinition(
                                                       "disableValidations", fromSimpleParameter("disableValidations").build())
                        .withSetterParameterDefinition(
                                                       "queryParamsStrictValidation",
                                                       fromSimpleParameter("queryParamsStrictValidation").build())
                        .withSetterParameterDefinition(
                                                       "headersStrictValidation",
                                                       fromSimpleParameter("headersStrictValidation").build())
                        .withSetterParameterDefinition("parser", fromSimpleParameter("parser").build())
                        .withSetterParameterDefinition(
                                                       "flowMappings", fromChildConfiguration(FlowMappings.class).build())
                        .build());

    definitions.add(
                    baseDefinition
                        .withIdentifier("flow-mappings")
                        .withTypeDefinition(fromType(FlowMappings.class))
                        .withSetterParameterDefinition(
                                                       "flowMappings",
                                                       fromChildCollectionConfiguration(FlowMapping.class).build())
                        .build());

    definitions.add(
                    baseDefinition
                        .withIdentifier("flow-mapping")
                        ...
                        .withSetterParameterDefinition(
                                                       "contentType", fromSimpleParameter("content-type").build())
                        .withSetterParameterDefinition("flowRef", fromSimpleParameter("flow-ref").build())
                        .build());

    definitions.add(
                    baseDefinition
                        .withIdentifier("router")
                        .withTypeDefinition(fromType(Router.class))
                        .withSetterParameterDefinition("name", fromSimpleParameter("name").build())
                        .withSetterParameterDefinition(
                                                       "configuration", fromSimpleReferenceParameter("config-ref").build())
                        .build());

    definitions.add(
                    baseDefinition
                        .withIdentifier("console")
