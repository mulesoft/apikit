 ...
 * <p>
 *
 * <p>All tokens can be represented as a text expression which cannot be <code>null</code>.
 *
 * <p>
 *
...
public interface Token extends Expandable {
   ...
   *
   * @return <code>true</code> if variables can be resolved from the specified pattern; <code>false
   *     </code> otherwise.
   */
   ...
   * <p>
   *
   * <p>The resolution process requires all variables referenced in the token to be mapped to the
   * value that is present in the expanded URI data.
   *
