 ...
 *
 * <p>To assign a {@link VariableResolver} to variables of a specific type, use {@link
 * #bindType(String, VariableResolver)}.
 *
 * <p>The following example will bind all variables typed <code>int</code> to return the
 ...
 * </pre>
 *
 * <p>To assign a {@link VariableResolver} to variables of a specific name, use {@link
 * #bindName(String, VariableResolver)}.
 *
 * <p>The following example will bind all variables typed <code>int</code> to return the
 * corresponding integer value.
 *
...
public class VariableBinder {
  ...
  private static final VariableResolver DEFAULT_RESOLVER =
   ...
   * <p>
   *
   * <p>This method does not return <code>null</code>. If the specified variable name is no bound to
   * any resolver the default resolver if returned instead.
   *
   ...
   * @return <code>true</code> if a given variable resolver is bound to the specific name; <code>
   *     false</code> otherwise (including if the name is <code>null</code>.
   */
   ...
   *
   * @param type The variable type.
   * @return <code>true</code> if a given variable resolver is bound to the specific type; <code>
   *     false</code> otherwise (including if the type is <code>null</code>.
   */
