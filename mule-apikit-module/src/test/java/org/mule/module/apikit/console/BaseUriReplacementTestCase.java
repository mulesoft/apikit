...
public class BaseUriReplacementTestCase {
  ...
  public void baseUriReplacementTest() throws Exception {
    RamlHandler ramlHandler =
        new RamlHandler(
                        "org/mule/module/apikit/console/simple-with-baseuri10.raml", false, muleContext);
    assertEquals(
                 "http://localhost:8081/api",
                 ramlHandler.getBaseUriReplacement("http://localhost:8081/api"));
    assertEquals(
                 "http://localhost:8081/api", ramlHandler.getBaseUriReplacement("http://0.0.0.0:8081/api"));
    ...
    assertEquals(
                 ...
                 ramlHandler.getBaseUriReplacement("http://localhost:8081/api"));
    assertEquals(
                 "http://pepe.cloudhub.io/api",
                 ramlHandler.getBaseUriReplacement("http://0.0.0.0:8081/api"));
    ...
    System.setProperty(FULL_DOMAIN, "pepe.cloudhub.io");
    assertEquals(
                 "http://localhost:8081/", ramlHandler.getBaseUriReplacement("http://localhost:8081/"));
    assertEquals(
                 "http://pepe.cloudhub.io/", ramlHandler.getBaseUriReplacement("http://0.0.0.0:8081/"));
    ...
    assertEquals(
                 "http://pepe.cloudhub.io/api", ramlHandler.getBaseUriReplacement("http://0.0.0.0:8081"));
  ...
  public void consoleUriReplacementTest() throws Exception {
    ...
    assertEquals(
                 ...
                 UrlUtils.getBaseUriReplacement("http://localhost:8081/console"));
    assertEquals(
                 "http://localhost:8081/console/",
                 UrlUtils.getBaseUriReplacement("http://localhost:8081/console/"));
    ...
    assertEquals(
                 "http://aamura.cloudhub.io/api/console",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console"));
    assertEquals(
                 "http://aamura.cloudhub.io/api/console/",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console/"));
    ...
    assertEquals(
                 "https://aamura.cloudhub.io/api/console",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console"));
    assertEquals(
                 "https://aamura.cloudhub.io/api/console/",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console/"));
    ...
    assertEquals(
                 "https://aamura.cloudhub.io/api/v1/console",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console"));
    assertEquals(
                 "https://aamura.cloudhub.io/api/v1/console/",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console/"));
    ...
    assertEquals(
                 "https://aamura.cloudhub.io/api/v1/console",
                 UrlUtils.getBaseUriReplacement("https://0.0.0.0:8081/console"));
    assertEquals(
                 "https://aamura.cloudhub.io/api/v1/console/",
                 UrlUtils.getBaseUriReplacement("https://0.0.0.0:8081/console/"));

    assertEquals(
                 "http://aamura.cloudhub.io/api/v1/console",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console"));
    assertEquals(
                 "http://aamura.cloudhub.io/api/v1/console/",
                 UrlUtils.getBaseUriReplacement("http://0.0.0.0:8081/console/"));
