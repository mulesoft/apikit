...
public class Schema10TestCase extends AbstractMultiParserFunctionalTestCase {
  ...
  public void postValidJsonUsingRamlType() throws Exception {
    given()
        .body("{\"firstname\":\"george\",\"lastname\":\"bernard shaw\",\"age\":30}")
        .contentType("application/json")
        .expect()
        .statusCode(200)
        .body(is("hello"))
  ...
  public void postValidJsonUsingRamlTypeSendingOtherParam() throws Exception {
    given()
        .body("{\"firstaname\":\"george\",\"lastname\":\"bernard shaw\",\"age\":\"30\"}")
        .contentType("application/json")
        .expect()
        .statusCode(400)
        // .body(is("hello"))
