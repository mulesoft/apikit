...
public class ConsoleRequestApiTestCase extends MuleArtifactFunctionalTestCase {
        ...
        .body(
              is(
                 "{\n"
                     ...
                     + "}\n"))
        .when()
        .get("/console-oas/org/mule/module/apikit/console/api/?api");
  }
  ...
  public void getRaml10Api() throws Exception {
    given()
        ...
        .when()
        .get("/console-raml-10/org/mule/module/apikit/console/api/?api");
  }
        ...
        .body(
              is(
                 "#%RAML 1.0 Library\n"
                     ...
                     + "     type: string\n"))
        .when()
        .get("/console-raml-10/org/mule/module/apikit/console/api/library.raml");
  }
  ...
  public void getRaml08() throws Exception {
    given()
        ...
        .body(
              is("#%RAML 0.8\n" + "title: emtpy body\n" + "/bug:\n" + "  post:\n" + "    body: {}\n"))
        .when()
        .get("/console-raml-08/org/mule/module/apikit/console/api/?api");
  }
}
