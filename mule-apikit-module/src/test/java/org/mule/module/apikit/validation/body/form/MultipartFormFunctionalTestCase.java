...
public abstract class MultipartFormFunctionalTestCase
    extends AbstractMultiParserFunctionalTestCase {

  @Test
  public void answer400WhenRequiredFormParameterIsNotProvided() throws Exception {
    given()
        .multiPart("Unnecessary", "Form Parameter")
        .expect()
        .response()
        .statusCode(400)
  ...
  public void answer400WhenRequiredFormParameterIsInvalid() throws Exception {
    given()
        .multiPart("userId", "I am not an integer HAHAHA")
        .expect()
        .response()
        .statusCode(400)
        .body(is("{message: 'Bad Request'}"))
  ...
  public void answer200WhenMultipleRequiredFormParameterAreProvided() throws Exception {
    given()
        ...
        .body(is("[\n" + "  \"userId\",\n" + "  \"second\",\n" + "  \"third\"\n" + "]"))
        .when()
        .post("/api/multiple-required-multipart");
  }
  ...
  public void answer200WhenMultipleOptionalFormParameterAreNotProvidedAndAdded() throws Exception {
    given()
        ...
        .body(is("[\n" + "  \"userId\",\n" + "  \"second\",\n" + "  \"third\"\n" + "]"))
        .when()
        .post("/api/multiple-optional-multipart");
  }
  ...
  public void answer400WhenOptionalFormParameterIsInvalid() throws Exception {
    given()
        .multiPart("content", "More than 10 characters")
        .expect()
        .response()
        .statusCode(400)
        .body(is("{message: 'Bad Request'}"))
