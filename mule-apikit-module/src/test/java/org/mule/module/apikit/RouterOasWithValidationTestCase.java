...
public class RouterOasWithValidationTestCase extends MuleArtifactFunctionalTestCase {
  ...
  public void getPetFindByStatus() throws Exception {
    given()
        ...
        .statusCode(200)
        .when()
        .get("/api/amf/oas/pet/findByStatus");
  }
  ...
  */
  ...
  private static String PET_POST_XML =
  ...
  private static String USER_POST_XML =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
          + "<User>\n"
          + "  <id>0</id>\n"
