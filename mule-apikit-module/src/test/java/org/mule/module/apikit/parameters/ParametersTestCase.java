...
public class ParametersTestCase extends AbstractMultiParserFunctionalTestCase {
  ...
  public void invalidBooleanQueryParamProvided() throws Exception {
    given()
        ...
        .when()
        .get("/api/resources?first=fi&third=yes");
  }

  @Test
  public void defaultValue() throws Exception {
    given().expect().response().statusCode(200).body(is("default")).when().get("/api/default");
  }

  @Test
  public void repeatableQueryParam() {
    given()
        .queryParam("status", "a", "b")
        .expect()
        .response()
        .statusCode(200)
        .when()
