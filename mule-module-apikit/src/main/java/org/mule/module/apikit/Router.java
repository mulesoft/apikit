...
public class Router extends AbstractRouter
{
    ...
    protected Flow getFlow(IResource resource, HttpRestRequest request) throws UnsupportedMediaTypeException
    {
        ...
        if (flow == null)
        {
            ...
            if (flow == null && isFlowDelaredWithDifferentMediaType(rawRestFlowMap, baseKey))
            {
    ...
    protected boolean isFlowDelaredWithDifferentMediaType(Map<String, Flow> map, String baseKey)
    {
