...
public class RamlHandlerTestCase
{
    ...
    @Test
    public void getRamlV2KeepRamlBaseUriTrue() throws NotFoundException, IOException
    {
        ...
        RamlHandler handler = new RamlHandler(ramlLocation, apiServer, keepRamlBaseUri);
        String rootRaml = handler.getRamlParserV2("../../../../org/mule/module/apikit/raml-handler/?raml");
    ...
    @Test
    public void getRamlV2KeepRamlBaseUriFalse() throws NotFoundException, IOException
    {
    ...
    @Test
    public void getRamlV2Example() throws NotFoundException, IOException
    {
        String ramlLocation = "../../../../org/mule/module/apikit/raml-handler/simple10-with-example.raml";
        String apiServer = "unused";
        boolean keepRamlBaseUri = true;
        RamlHandler handler = new RamlHandler(ramlLocation, apiServer, keepRamlBaseUri);
        assertTrue(handler.getRamlParserV2("../../../../org/mule/module/apikit/raml-handler/example.json/?raml").contains("{\"name\":\"jane\"}"));
    }
}
