...
public class APISyncUtilsTest {
  ...
  private static final String TEST_RESOURCE_WITH_FOLDER =
      EXCHANGE_MODULES_GAV + "/" + FOLDER + "/" + FILE_RAML;
  ...
  private static final String RESOURCE_GAV =
      "resource::" + ORG_ID + ":" + ARTIFACT_ID + ":" + VERSION + ":raml-fragment:zip:";
  ...
  private static final String RESOURCE_ORG_ID_ARTIFACT_ID_1_0_0_RAML_FRAGMENT_ZIP_WITHOUT_FILE_RAMLL =
      RESOURCE_GAV + FILE_RAML;
  ...
  private static final String RESOURCE_STRING_IS_NOT_CORRECTLY_FORMED =
      "Resource string is not correctly formed";
  ...
  public void testAPISyncResourceStringWithIncludesInsideSubfolders() {
    ...
    Assert.assertEquals(
                        RESOURCE_STRING_IS_NOT_CORRECTLY_FORMED,
                        RESOURCE_ORG_ID_ARTIFACT_ID_1_0_0_RAML_FRAGMENT_ZIP_FOLDER_FILE_RAML,
                        apiSyncResourceString);
  }
  ...
  public void testAPISyncResourceStringWithIncludesInsideSubfoldersInsideSubfolder() {
    ...
    Assert.assertEquals(
                        RESOURCE_STRING_IS_NOT_CORRECTLY_FORMED,
                        RESOURCE_ORG_ID_ARTIFACT_ID_1_0_0_RAML_FRAGMENT_ZIP_FOLDER_TWICE_FILE_RAML,
                        apiSyncResourceString);
  }
  ...
  public void testAPISyncResourceStringWithoutFolders() {
    ...
    Assert.assertEquals(
                        RESOURCE_STRING_IS_NOT_CORRECTLY_FORMED,
                        RESOURCE_ORG_ID_ARTIFACT_ID_1_0_0_RAML_FRAGMENT_ZIP_WITHOUT_FILE_RAMLL,
                        apiSyncResourceString);
  }
  ...
  public void testApiSyncResourceWithoutExchangeModulesAtTheStartShouldNotMatch() {
    ...
    Assert.assertNull(
                      RESOURCE_STRING_WITHOUT_EXCHANGE_MODULES_SHOULD_NOT_MATCH, apiSyncResourceString);
  }
}
